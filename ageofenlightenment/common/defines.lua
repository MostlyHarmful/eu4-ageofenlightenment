...
NDiplomacy = {
	...
	SUPPORT_REBELS_DURATION = 15, -- in years
...
NCountry = {
	...
	MAX_NATIONALISM = 10,
	YEARS_OF_NATIONALISM = 50, 						-- _CDEF_YEARS_OF_NATIONALISM_; Years of Nationalism
	...
	DICTATORSHIP_TRADITION_FOR_REPUBLIC = 25,		-- If republican tradition is this or higher on death of ruler, dictatorship turns into republic
